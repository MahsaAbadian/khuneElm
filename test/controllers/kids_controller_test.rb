...
class KidsControllerTest < ActionController::TestCase
  ...
  test "should create kid" do
    assert_difference('Kid.count') do
      post :create, kid: { first_name: @kid.first_name, last_name: @kid.last_name, status: @kid.status }
    end
  ...
  test "should update kid" do
    patch :update, id: @kid, kid: { first_name: @kid.first_name, last_name: @kid.last_name, status: @kid.status }
    assert_redirected_to kid_path(assigns(:kid))
  end
